 ...
 * resolving to the real control). Use this for local fetches/refetches; the
 * global loading bar (`loadingState`) is reserved for app bootstrap, auth
 * establishment, and space switch.
 */
