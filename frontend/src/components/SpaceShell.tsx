...
export function SpaceShell(props: SpaceShellProps) {
  ...
  return (
    <main class="ui-shell">
          ...
          <div class="ui-topbar-center">
            <div class="ui-floating ui-tabs">
              <a
                ...
                class="ui-tab"
                classList={{
                  "ui-tab-active": props.activeTopTab === "dashboard",
                }}
              >
      ...
      <div
        class={`ui-content ${
          props.showBottomTabs ? "ui-content-with-tabs" : ""
        }`}
      >
        {props.children}
      </div>
          ...
          <div class="ui-floating ui-tabs">
            <a
              href={`/spaces/${props.spaceId}/entries${
                props.bottomTabHrefSuffix || ""
              }`}
              class="ui-tab ui-tab-secondary"
              classList={{
                "ui-tab-active": props.activeBottomTab === "object",
              }}
              >
