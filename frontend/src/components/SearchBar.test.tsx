...
describe("SearchBar", () => {
  ...
  it("should accept custom placeholder", () => {
    render(() => (
      <SearchBar onSearch={vi.fn()} placeholder="Find something..." />
    ));
    expect(screen.getByPlaceholderText("Find something..."))
      .toBeInTheDocument();
  });
  ...
  it("REQ-FE-044: renders localized zero-result fallback when count is nullish", () => {
    setLocale("ja");
    render(() => (
      <SearchBar onSearch={vi.fn()} resultsCount={null as unknown as number} />
    ));
