...
export default function Nav() {
  ...
  const homeLabel = createMemo(() => t("nav.home"), undefined, {
    equals: false,
  });
  const spacesLabel = createMemo(() => t("nav.spaces"), undefined, {
    equals: false,
  });
  const loginLabel = createMemo(() => t("nav.login"), undefined, {
    equals: false,
  });
  const aboutLabel = createMemo(() => t("nav.about"), undefined, {
    equals: false,
  });
  ...
  const isSpaceExplorer = location.pathname.includes("/spaces/") &&
      ...
      <ul class="ui-nav-list">
        <li>
          <a
            href="/"
            class="ui-nav-link"
            classList={{ "ui-nav-link-active": active("/") }}
          >
            <span>{homeLabel()}</span>
          </a>
        </li>
