...
describe("AssetUploader", () => {
  ...
  it("should allow removing assets", () => {
    ...
    render(() => (
      <AssetUploader onUpload={vi.fn()} assets={assets} onRemove={onRemove} />
    ));
  ...
  it("REQ-FE-044: localizes asset uploader controls in Japanese", () => {
    ...
    render(() => (
      <AssetUploader onUpload={vi.fn()} assets={assets} onRemove={vi.fn()} />
    ));
    ...
    expect(screen.getByLabelText("アセット doc.pdf を削除"))
      .toBeInTheDocument();
  });
});
