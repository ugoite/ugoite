      ...
      >
        <div class="empty-state p-12 text-center">
          <div class="flex flex-col items-center">
            ...
            <p class="ui-muted font-medium mb-1">
              {t("listPanel.empty.entries.title")}
            </p>
            <Show
              when={props.forms.length === 0}
              fallback={
                <p class="text-sm ui-muted">
                  {t("listPanel.empty.entries.description")}
                </p>
              }
            >
              <p class="text-sm ui-muted">
                {t("listPanel.empty.entries.noForms")}
              </p>
            </Show>
          </div>
        </div>
      ...
      fallback={
        <div class="empty-state p-12 text-center">
          <div class="flex flex-col items-center">
            ...
            <p class="ui-muted font-medium mb-1">
              {t("listPanel.empty.forms.title")}
            </p>
            <p class="text-sm ui-muted">
              {t("listPanel.empty.forms.description")}
            </p>
          </div>
        </div>
      }
