...
export default function WorkspaceQueryVariablesRoute() {
	const params = useParams<{ workspace_id: string; query_id: string }>();
	...
	const [entry] = createResource(async () => sqlApi.get(workspaceId(), queryId()));
