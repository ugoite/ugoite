        ...
        <section class="ui-card ui-stack">
          <div class="ui-stack-sm">
            ...
            <p class="ui-page-subtitle max-w-2xl">
              This legacy <code>/query</code>{" "}
              URL is kept only so older bookmarks and stale links do not fail.
              Ugoite&apos;s supported query and search flow now lives under{" "}
              <code>/search</code>, where keyword search, advanced filters, and
              query history are available together.
            </p>
          </div>
          ...
          <div class="ui-stack-sm">
            ...
            <ul class="list-disc space-y-2 pl-5 text-sm ui-muted">
              <li>
                Open Search to continue with the supported query experience.
              </li>
              <li>
                Update old bookmarks or shared links that still point to{" "}
                <code>/query</code>.
              </li>
              <li>
                Return to the dashboard if you were only trying to get back into
                this space.
              </li>
            </ul>
          </div>
