			...
			<div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-left">
				<div class="p-6 bg-white rounded-lg shadow">
					...
					<p class="text-gray-600 text-sm">
						Write in Markdown, get structured data. Use H2 headers to define
						properties like dates, status, and more.
					</p>
				</div>
				<div class="p-6 bg-white rounded-lg shadow">
					<h3 class="text-lg font-semibold mb-2">🤖 AI Native</h3>
					<p class="text-gray-600 text-sm">
						Built for AI agents. Execute scripts, query your knowledge base,
				...
				<div class="p-6 bg-white rounded-lg shadow">
					...
					<p class="text-gray-600 text-sm">
						Organize notes visually on a 2D canvas. Create connections and
						see the big picture.
					</p>
				</div>
			</div>
