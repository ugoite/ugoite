...
REQ-OPS-023: Docsite 100% coverage must be explicit in CI and root mise test.
"""
...
def test_docs_req_ops_023_docsite_coverage_gate_is_explicit() -> None:
    """REQ-OPS-023: Docsite 100% coverage must stay explicit in CI and root tests."""
    root_mise = tomllib.loads(MISE_PATH.read_text(encoding="utf-8"))
    root_runs = _get_task_run_commands(root_mise, "test")
