"""REQ-E2E-008: Browser walkthrough explains the Search surface to newcomers."""
...
def test_docs_req_e2e_008_browser_walkthrough_explains_search_surface() -> None:
    """REQ-E2E-008: Browser walkthrough must explain Search and why it matters."""
