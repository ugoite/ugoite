...
Every task page answers what became durable in the Space. Search indexes, SQL
sessions, and runtime state are derived and replaceable; Forms, Entries, Assets,
saved SQL, Changes, and portable history are authoritative Space content.
