...
| Policy `linked_philosophies` | Rule `governed_by` | Governance is authored once on the canonical Policy Rule. Reverse views are derived by `SpecIndex`; Foundation precedence is represented by the dedicated canonical Policy. |
