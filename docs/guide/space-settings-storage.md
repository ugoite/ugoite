...
3. preserve permissions for the non-root runtime user (`10001` in supplied container/chart defaults);
4. update configuration;
5. run the connection test and representative reads before deleting the old copy.
