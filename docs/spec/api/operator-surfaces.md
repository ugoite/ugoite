...
Choose the narrowest surface that matches the operator. All surfaces delegate to the same core behavior rather than implementing separate business rules. MCP intentionally omits broad orchestration, storage details, and revision CRUD.
