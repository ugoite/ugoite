...
- Keep path/method/body/decoding rules in `ugoite-api-client` when both CLI and browser use them.
- Keep credentials and runtime transport outside the portable crate.
- Do not infer feature completeness from a placeholder command or planned specification entry.
