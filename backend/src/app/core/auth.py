"""Authentication primitives and request identity helpers."""
...
class AuthManager:
    ...
    def authenticate(self, request: Request) -> RequestIdentity:
...
def authenticate_request(request: Request) -> RequestIdentity:
    ...
    return get_auth_manager().authenticate(request)
