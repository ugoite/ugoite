...
@pytest.mark.xfail(reason="Sandbox isolation requires bwrap/nsjail which is not available in this dev env")
...
"""
    ...
    assert "Permission denied" in result.stderr or "FileNotFoundError" in result.stderr or result.returncode != 0
